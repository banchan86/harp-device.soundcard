...
The Harp [SoundCard](articles/soundcard-overview.md) and [peripherals](articles/audio-peripherals.md) are open-source, high-fidelity audio devices specifically designed for behavioral research experiments. 
