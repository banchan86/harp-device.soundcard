...
The harp-python library imports data stored in the Harp binary format as [pandas](https://pandas.pydata.org/) DataFrames. The following example demonstrates how to read and plot data from a specific register:
