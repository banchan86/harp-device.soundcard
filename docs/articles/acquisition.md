...
The [`DeviceDataWriter`] in the Harp device pattern will log raw data from all device registers in the Harp binary format, which can be analyzed directly with [harp-python](visualize-data.md).
