## Upload waveforms with Bonsai

The [Harp.SoundCard](../articles/installation.md#software-packages) Bonsai package supports preload and update of sound waveforms during runtime. The following exercises will demonstrate how to generate and load various waveforms for upload to the SoundCard in Bonsai.
...
:::workflow
![UpdateSoundWaveform Operator](../workflows/uploadwaveform-updatesoundwaveform.bonsai)
:::
...
:::workflow
![Upload Waveform Pure Tone](../workflows/uploadwaveform-puretone.bonsai)
:::
...
:::workflow
![Upload Waveform White Noise](../workflows/uploadwaveform-whitenoise.bonsai)
:::
...
:::workflow
![Upload Waveform BIN File](../workflows/uploadwaveform-binfile.bonsai)
:::
